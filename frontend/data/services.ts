...
export const services: Service[] = [
  insuranceService({
    ...
    metaTitle: "Insurance Claim Rejected or Delayed? Get Claim Support | VB Consultants",
    metaDescription: "Upload your policy copy, rejection letter or claim papers. VB Consultants helps with insurance claim documentation, follow-up, rejection review and escalation support.",
    heroTitle: "Insurance Claim Rejected or Delayed? Get Claim Support",
    heroText: "Upload your policy copy, rejection letter or claim papers. VB Consultants helps with claim documentation, follow-up, rejection review, settlement paperwork and escalation support where required.",
    ...
    related: ["insurance-claim-rejected", "health-insurance-claim-help", "cashless-claim-denied"],
  ...
  },
  {
    ...
    label: "ITR Filing",
    category: "itr",
    metaTitle: "ITR Filing Online | Salary, Capital Gains and Business ITR Support",
    metaDescription: "Simple ITR filing support for salary, Form 16, capital gains, freelancer and business income cases.",
    heroTitle: "ITR filing support for salary, capital gains and business income.",
    heroText: "Start with your phone number and upload available documents. We will check which ITR route fits your case.",
    whoFor: ["Salaried people", "Pensioners", "Capital gains cases", "Freelancers", "Small business owners"],
    whatWeDo: ["Understand income type", "Check available documents", "Guide the ITR form route", "Confirm fee before work", "Track request status"],
    documents: ["Form 16 if applicable", "PAN", "Aadhaar", "AIS / Form 26AS", "Capital gains or business records if applicable", "Bank details"],
    process: standardProcess,
    priceNote: "Salary ITR starts from ₹199 onwards. Other cases are quoted after document review.",
    faqs: serviceFaqs,
    related: ["salary-itr-filing", "itr-1-filing", "itr-2-capital-gains-filing"]
  },
  {
    slug: "itr-1-filing",
    label: "ITR-1 Filing",
  ...
  {
    slug: "income-tax-notice-help",
    label: "Income Tax Notice Help",
    category: "support",
    metaTitle: "Income Tax Notice Help | Upload Notice and Get Next Steps",
    metaDescription: "Upload your income tax notice, AIS/Form 26AS and related documents for simple next-step support.",
    heroTitle: "Income tax notice help with simple next steps.",
    heroText: "Received a notice? Upload the document and related records. Our team will check the issue and contact you.",
    whoFor: ["People with income tax notices", "AIS or Form 26AS mismatch cases", "Demand or defective return notices", "Salary and business users"],
    whatWeDo: ["Check notice type", "Review deadline and records", "Prepare missing document list", "Guide response steps", "Track status"],
    documents: ["Notice copy", "PAN", "ITR acknowledgement", "AIS / Form 26AS", "Bank and income records"],
    process: standardProcess,
    priceNote: "Notice help is custom priced after checking notice type and records.",
    faqs: serviceFaqs,
    related: ["tax-notice-help", "salary-itr-filing", "gst-services"]
  },
  {
