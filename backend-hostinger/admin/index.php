...
<div class="grid two" style="margin-top:18px">
  <div class="card">
    ...
    <?php foreach ($latestLeads as $lead): ?>
      <p><strong><?= e($lead['phone']) ?></strong> · <?= e($lead['service']) ?><br><span class="muted"><?= e($lead['name']) ?> · <?= e($lead['created_at']) ?></span></p>
  ...
  <div class="card">
    ...
    <?php foreach ($latestRequests as $request): ?>
      <p><strong><?= e($request['request_code']) ?></strong> · <?= e($request['service_type']) ?><br><?= status_badge($request['status']) ?> <span class="muted"><?= e($request['full_name']) ?> · <?= e($request['phone']) ?></span></p>
